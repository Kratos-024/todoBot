...
//     return {
//       type: "location",
//       content: `User shared location: ${message.message.locationMessage.degreesLatitude}, ${message.message.locationMessage.degreesLongitude}`,
...
//   ) {
//     return { type: "contacts", content: "User shared contact(s)" };
//   } else if (message.message.audioMessage) {
//     return { type: "audio", content: "User sent audio", messageObj: message };
